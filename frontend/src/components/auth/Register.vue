      ...
      >
        ...
        <div class="terms-checkbox mb-3 form-check">
          ...
          <label class="form-check-label" for="terms"
            >I've read and agree with your Terms of Services</label
          >
          <div class="invalid-feedback">You must agree to the terms</div>
        </div>

        <button type="submit" class="submit-btn btn btn-primary w-100 mb-3">
          Create Account →
        </button>
        ...
        <div class="social-logins mb-3">
          <button
            type="button"
            class="social-btn facebook btn btn-outline-primary"
          >
            <svg class="social-icon" viewBox="0 0 24 24">
              <path
                fill="#1877F2"
          ...
          <button
            type="button"
            class="social-btn google btn btn-outline-danger"
          >
            <svg class="social-icon" viewBox="0 0 24 24">
              <path
                fill="#DB4437"
